...
# User Input
base_name="deepi_spline_G18_10a_02_11a"  # input/output files base name
...
nevts="1000000"       # total number of events generated
...
cmd_xml="gmkspl -p ${beam_pdg} -t ${tgt_pdg_d2} -e ${Eb_max} -n 250 -o ${base_name}.xml --tune ${tune} "
eval ${cmd_xml}
...
cmd_gen="gevgen -n ${nevts} -p ${beam_pdg} -t ${tgt_pdg_d2} -e ${Eb} --tune ${tune} --cross-sections ${base_name}.xml -o ${base_name}" 
